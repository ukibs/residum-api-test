...
import { deleteHousing } from "../../dependencies/usecases/housing.usecase";
import { isNil } from "../../../../shared/utils/type-checkers";

export async function deleteHousingController(req: Request): Promise<Response> {
    ...
    try {
        const [result, error] = await deleteHousing({
