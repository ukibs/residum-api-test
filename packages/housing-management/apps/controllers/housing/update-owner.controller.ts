...
import { updateOwner } from "../../dependencies/usecases/housing.usecase";
import { isNil } from "../../../../shared/utils/type-checkers";

export async function updateOwnerController(req: Request): Promise<Response> {
    ...
    try {
        const [result, error] = await updateOwner({
