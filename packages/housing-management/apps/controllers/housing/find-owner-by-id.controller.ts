...
import { getOwnerById } from "../../dependencies/usecases/housing.usecase";
import { isNil } from "../../../../shared/utils/type-checkers";

export async function findOwnerByIdController(req: Request): Promise<Response> {
    ...
    try {
        const [result, error] = await getOwnerById({
